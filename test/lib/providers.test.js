...
describe('VisionWeb.lib.providers', async function () {
    ...
    describe('#constructor()', function () {
        ...
        it('should create a full instance', function () {
            ...
            provider = new VisionWeb.providers.HttpProvider
            ('www.exaple.com');
            assert.instanceOf(provider, VisionWeb.providers.HttpProvider);
        });
        ...
        it('should throw if the host is not valid', function () {
            ...
            assert.throws(() => new VisionWeb.providers.HttpProvider(
                '$' + FULL_NODE_API
    ...
    describe('#setStatusPage()', function () {
        ...
        it('should set a status page', function () {
            const provider = new VisionWeb.providers.HttpProvider(FULL_NODE_API);
    ...
    describe('#isConnected()', function () {
        ...
        it('should return false if the url is not one of the expected provider', async function () {
            const provider = new VisionWeb.providers.HttpProvider('https://google.com');
